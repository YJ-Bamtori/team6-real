...
document.addEventListener("DOMContentLoaded", function() {
    var animations = [
        {id: 'cam', path: 'cam.json'},
        {id: 'tennis', path: 'tenis.json'},
        {id: 'cake', path: 'cake.json'},
        {id: 'picture', path: 'picture.json'},
        {id: 'plant2', path: 'plant2.json'},
        {id: 'ploging', path: 'ploging.json'},
        {id: 'cook', path: 'cook.json'},
        {id: 'triangle', path: 'triangle.json'},
        {id: 'sing', path: 'sing.json'},
        {id: 'book', path: 'book.json'},
        {id: 'hat', path: 'hat.json'},
        {id: 'plant', path: 'plant.json'},
        {id: 'cut', path: 'cut.json'},
    ];
